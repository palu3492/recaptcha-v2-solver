...
class RecaptchaTest():
    ...
    def find_label(self):
        label = self.web_driver.find_element_by_css_selector("div[class^='rc-imageselect-desc'] strong")
    ...
    def separate_image(self, download_number):
        self.separate_image.set_image_data(download_number)
        self.separate_image.separate(download_number)
